...
const UpdateEquipments = () => { 
  ...
  const { _id, name, category, price, rating, stock, pTime, imgurl, description, userName, userEmail } = singleData || {}; 
    ...
    <section> 
      ...
      <div className="container mx-auto p-10"> 
        <div className="bg-white shadow-md rounded-lg p-6 md:p-8"> 
          <h1 className="text-2xl font-bold text-gray-900 mb-6">Update Equipment</h1> 
          ...
          <form onSubmit={handleUpdate} className="space-y-6"> 
            ...
            {/* Image URL */}
            <div className="space-y-2"> 
              <label className="block text-sm font-medium text-gray-700">Image (Direct link)</label> 
              <input 
                type="text" 
                name="imgurl" 
                defaultValue={imgurl} 
